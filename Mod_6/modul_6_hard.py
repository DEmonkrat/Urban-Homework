...
class Figure:
    ...
    def __init__(self, color, *sides, filled):
        ...
        if not self.__is_valid_sides(*self.__sides):
            ...
            self.__sides = sides * self.SIDES_COUNT  # Для Куба. Размножаем одну сторону
    ...
    def __is_valid_sides(self, *args):
        ...
        # Вводим переменную sd_cnt для проверки Куба (у него передаем 1 сторону вместо 12)
...
print(f'Стороны (окружность): {circ1.get_sides()}')
...
print(f'Стороны (окружность): {circ2.get_sides()}')
...
print(f'Стороны (окружность): {circ3.get_sides()}')
...
print(f'Стороны (окружность): {circ4.get_sides()}')
...
print(f'Цвет: {circ4.get_color()}')
print('Периметр кураг: ', len(circ4))
...
print('Периметр треугольника: ', len(trng2))
print()
print()
